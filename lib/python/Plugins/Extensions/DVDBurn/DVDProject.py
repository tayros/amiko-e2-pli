...
class DVDProject:
	...
	def __init__(self):
		...
		self.settings.authormode = ConfigSelection(choices = [("menu_linked", _("Linked titles with a DVD menu")), ("just_linked", _("Direct playback of linked titles without menu")), ("menu_seperate", _("Seperate titles with a main menu")), ("data_ts", _("set-top-box format data DVD (HDTV compatible)"))])
