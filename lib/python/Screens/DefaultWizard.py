...
#			os_system("mount %s %s" % (resolveFilename(SCOPE_DEFAULTPARTITION), self.directory))
	...
	def statusCallback(self, status, progress):
		...
		if status == DreamInfoHandler.STATUS_DONE:
			self["text"].setText(_("The installation of the default settings is finished. You can now continue configuring your set-top-box by pressing the OK button on the remote control."))
			self.markDone()
