...
class AdapterSetupConfiguration(Screen, HelpableScreen):
	def __init__(self, session,iface):
		...
		self.oktext = _("Press OK on your remote control to continue.")
		self.reboottext = _("Your set-top-box will restart after pressing OK on your remote control.")
	...
	def loadDescription(self):
		if self["menulist"].getCurrent()[1] == 'edit':
			self["description"].setText(_("Edit the network configuration of your set-top-box.\n" ) + self.oktext )
		if self["menulist"].getCurrent()[1] == 'test':
			self["description"].setText(_("Test the network configuration of your set-top-box.\n" ) + self.oktext )
		if self["menulist"].getCurrent()[1] == 'dns':
			self["description"].setText(_("Edit the Nameserver configuration of your set-top-box.\n" ) + self.oktext )
		if self["menulist"].getCurrent()[1] == 'scanwlan':
